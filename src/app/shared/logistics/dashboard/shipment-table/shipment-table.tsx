...
import { getColumns } from "@/app/shared/logistics/dashboard/shipment-table/shipment-table-columns";
import ShipmentTableFilters from "@/app/shared/logistics/dashboard/shipment-table/shipment-table-filters";
...
export default function ShipmentTable() {
  ...
  const {
    ...
    handleDelete,
    handleReset,
  } = useTable(pendingShipments, pageSize, filterState);
